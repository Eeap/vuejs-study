                                    ...
                                    <div class="text-center">
                                        <v-dialog v-model="dialogPayment" max-width="500px">
                                            <template v-slot:activator="{ on, attrs }">
                                                <v-btn v-bind="attrs" v-on="on" icon medium>
                                        ...
                                        <v-menu v-model="menu" :close-on-content-click="false" :nudge-width="200" offset-x>
                                            <template v-slot:activator="{ on, attrs }">
                                                <v-btn v-bind="attrs" v-on="on">
                                                    <v-icon medium>fas fa-money-check-dollar</v-icon></v-btn>
                                            </template>
                                                        ...
                                                        <v-list-item-content>
                                                                <v-list>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <v-list-item v-for="item in payDataList">
                                                                            <v-list-item-content>
                                                        ...
                                                        <v-list-item-content>
                                                                <v-list>
                                                                    ...
                                                                    >
                                                                        ...
                                                                        <v-list-item v-for="item in revenueDataList">
                                                                            <v-list-item-content>
                                                                                <v-list-item-subtitle v-text="item"></v-list-item-subtitle>
                                                                            </v-list-item-content>
                                                                        </v-list-item>
                        ...
                        if (date.getFullYear()==parseInt(year)) {
                            ...
                            if (date.getMonth()+1==month) {
                                if (items[i]['category']=="지출") {
                                    ...
                                    this.payDataList.push(items[i]['details']+" "+items[i]['name']+"원")
                                } else {
                                    this.plus+=parseInt(items[i]['money'])
                                    this.revenueDataList.push(items[i]['details']+" "+items[i]['name']+"원")
                                }
