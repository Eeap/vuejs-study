...
<html lang="en">
    ...
    <body>
        <div id="app">
            <v-app>
                <v-app-bar color="cyan" dark absolute>
                    <v-toolbar-title>
                        <v-btn outlined class="mr-4" color="grey darken-2" @click="main">Home</v-btn>
                    </v-toolbar-title>
                </v-app-bar>
                <v-main id="app">
                    <v-row class='fill-height'>
                                        ...
                                        <div class="text-center">
                                            <v-menu
                                                ...
                                                <v-card>
                                                    ...
                                                    <v-list>
                                                        <v-list-item>
                                                            <v-list-item-title>지출 금액 :
                                                                {{ minus }}원</v-list-item-title>
                                                        </v-list-item>

                                                        <v-list-item>
                                                            <v-list-item-title>수익 금액 :
                                                                {{ plus }}원</v-list-item-title>
                                                        </v-list-item>
                                                    </v-list>
                                ...
                                <v-menu
                                    ...
                                    <v-card color="grey lighten-4" min-width="350px" flat>
                                        ...
                                        <v-card-text>
                                            ...
                                            <v-spacer></v-spacer>
                                            <v-btn :disabled="disabled" @click="editCalendar" icon>
                                                <v-icon dark right="right">mdi-checkbox-marked-circle</v-icon>
                                            </v-btn>
                                        </v-card-text>
                                        <v-card-actions>
                                            <v-btn
                                                text
                                                color="secondary"
                                                @click="selectedOpen = false,disabled = true, readonly=true,reload()">Cancel</v-btn>
                                        </v-card-actions>
                                    </v-card>
                                </v-menu>
                            </v-sheet>
                        ...
                        <v-col cols="auto">
                            <v-card>
                                ...
                                <v-divider></v-divider>
                                <v-spacer></v-spacer>
                                <v-form ref="form" @submit.prevent="save" lazy-validation="lazy-validation">
                                    <v-text-field
                                        id="content"
                                        name="content"
                                        type="type"
                                    ...
                                    <v-currency-field
                                        ...
                                        filled
                                        outlined
                                        :decimal-length="0"></v-currency-field>
                                    <v-select
                                        :items="categories"
                                        v-model="category"
                                        label="항목"
